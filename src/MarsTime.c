...
void handle_init(void) {
  ...
  txt_title = text_layer_create(GRect(/* x: */ 0, /* y: */ 0,
                                       /* width: */ 144, /* height: */ 30));
  txt_time_years = text_layer_create(GRect(0,31,144,60));
  txt_time_years_lbl = text_layer_create(GRect(0,102,144,40));
  /*
  txt_time_days = text_layer_create(GRect(0,31,144,60));
  txt_time_days_lbl = text_layer_create(GRect(0,102,144,40));
  */
  ...
  text_layer_set_font(txt_time_years, fonts_get_system_font(FONT_KEY_GOTHIC_28));
